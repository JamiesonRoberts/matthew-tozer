export default function StructuredData({ locationData }) {
    ...
    hasCredential: [
      {
        ...
        abstract:
          'The hybridization of the traditional baroque dance movements with the classical concerto featuring the 17th century instrument, the Viola da Gamba in combination with the string orchestra.',
        about: {
          '@type': 'EducationalOccupationalProgram',
          educationalCredentialAwarded:
            'Doctor of Philosophy (Ph.D.) - Music Composition',
          startDate: '2007',
          endDate: '2014',
          provider: {
      ...
      },
      {
        ...
        about: {
          '@type': 'EducationalOccupationalProgram',
          educationalCredentialAwarded:
            'Honours Bachelor of Music - Music Theory and Composition',
          startDate: '2001',
          endDate: '2005',
          provider: {
            '@type': 'CollegeOrUniversity',
  ...
  const localBusiness = {
    ...
    image: 'https://matthewtozer.com/mtozerheadshot.jpg',
    url: 'https://matthewtozer.com',
    sameAs: ['https://maps.google.com/?cid=9221277794800284912'],
    email: 'matttozer@gmail.com',
    telephone: '+15198577942',
    address: {
      '@type': 'PostalAddress',
