    ...
    <main className={styles.main} style={{ gridArea }}>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          as a freelance composer, sessional instructor, and operates a private
          studio. He holds a PhD in Music Composition from the University of
          Western Ontario and is a member of the{' '}
          <Link
          ...
          baroque dance movements with the classical concerto featuring the 17th
          century instrument, the Viola da Gamba in combination with the string
          orchestra. Matthew is also an advocate of strong music education and
          has participated in many university level instructional courses.
        </p>
        <p>
          ...
          compositions have been programmed in festivals and work-shopped and/or
          performed by organizations and groups including: The Toronto Symphony
          Orchestra, Four Corners Ensemble, Soundscape Music Festival, TorQ
          Percussion, The Bozzini String Quartet, Space City New Music Festival,
          The Erato Ensemble, The Strathcona Quartet, Domaine Forget, The
          Vancouver Chamber Choir, The Aventa Ensemble, Soundstreams Canada,
          Charlotte New Music Festival, The Madawaksa String Quartet,
          Soundstreams Festival, and Pacific Opera Victoria.
        </p>
      </section>
    </main>
  )
